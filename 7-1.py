...
def drawPyramid_glVertex():
    glBegin(GL_TRIANGLES)
    glVertex3f(0., 0., 0.) # v0
    glVertex3f(0., 0., 1.5) # v1
    glVertex3f(1.5, 0., 0.) # v2
    
    glVertex3f(0., 0., 0.) # v0
    glVertex3f(1.5, 0., 0.) # v2
    glVertex3f(0., 1.5, 0.) # v3
...
def main():
    ...
    if not glfw.init():
        return
    window = glfw.create_window(480,480,'7-1', None,None)
    if not window:
        glfw.terminate()
        return
